...
{ var text;
 ...
 puncte.push( { x : x_coord, y : y_coord } );		// baga coordonatele in vectorul de puncte 
   ...
   /* puncte.push( { x : 172, y :  96} );
	puncte.push( { x : 346, y :  111} );	
	puncte.push( { x : 378, y :  217} );	
	puncte.push( { x : 317, y :  375} );	
	puncte.push( { x : 129, y :  368} );	
	puncte.push( { x : 79, y :  207} );	*/
	
 deseneaza_punct(x_coord, y_coord);		//apoi trimite coordonatele catre functia care deseneaza efectiv punctul

   /* deseneaza_punct(172, 96);	
	deseneaza_punct(346, 111);	
	deseneaza_punct(378, 217);	
	deseneaza_punct(317, 375);	
	deseneaza_punct(129, 368);	
	deseneaza_punct(79, 207);  */
}
